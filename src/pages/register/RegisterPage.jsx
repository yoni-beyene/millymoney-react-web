      ...
      >
        <div className="login-container px-5">
          ...
          <div className="hero">
            ...
            <p className="subHero">
              Please enter your information to finish creating your account.
            </p>
          </div>
          <Formik
              ...
              <div className="modalContent">
                ...
                <div className="modalText">
                  <p>
                    ...
                    pulvinar dolor vitae metus ultricies, non porttitor nisi
                    sollicitudin. Mauris non risus id sapien suscipit
                    consectetur. Nulla facilisi.
                  </p>
                  <p>
                    Quisque pharetra erat ut est feugiat, ut tincidunt sapien
                    posuere. Donec id lacus nec velit porttitor luctus ac eget
                    nisl.
                  </p>
                </div>
                <button
